...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    const tNumber = 1;
    const tNumberTriviaModel = NumberTriviaModel('Test', tNumber);
    ...
    group('device is online', () {
      ...
      test(
          'should return server failure when the call to remote data source is failure',
          () async {
        // arrange
        when(mockRemoteDataSource.getConcreteNumberTrivia(any))
  ...
  group('getRandomNumberTrivia', () {
    const tNumberTriviaModel = NumberTriviaModel('Test', 123);
    const NumberTrivia tNumberTrivia = tNumberTriviaModel;
